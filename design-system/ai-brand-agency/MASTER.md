...
**Project:** AI Brand Agency
**Generated:** 2026-06-24
**Category:** Premium Creative Web Agency
...
|------|-----|--------------|
| Primary | `#F3F0EA` | `--color-primary` |
| On Primary | `#111111` | `--color-on-primary` |
| Secondary | `#AAA7A1` | `--color-secondary` |
| Accent/CTA | `#FF5A1F` | `--color-accent` |
| Background | `#070707` | `--color-background` |
| Foreground | `#F3F0EA` | `--color-foreground` |
| Muted | `#AAA7A1` | `--color-muted` |
| Border | `rgba(255,255,255,0.13)` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#EC4899` | `--color-ring` |

**Color Notes:** Dark editorial base with warm white type and one controlled orange conversion accent.
...
- **Mood:** editorial, premium, modern, precise
...
**Style:** Dark Editorial Tech-Luxury

**Keywords:** premium dark, oversized type, warm graphite, chrome forms, orange accent, modern editorial grid, cinematic web studio
